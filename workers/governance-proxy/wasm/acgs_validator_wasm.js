/* @ts-self-types="./acgs_validator_wasm.d.ts" */
...
export class WasmValidator {
    ...
    const_hash() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmvalidator_const_hash(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    constructor(config_json) {
        ...
        const ret = wasm.wasmvalidator_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        WasmValidatorFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    validate(input_json) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmvalidator_validate(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @param {string} text_lower
     * @returns {string}
     */
    validate_hot(text_lower) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(text_lower, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmvalidator_validate_hot(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./acgs_validator_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('acgs_validator_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
