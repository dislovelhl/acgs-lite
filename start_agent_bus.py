...
# Add local workspace paths before any globally installed or sibling checkout packages.
...
os.environ["PYTHONPATH"] = os.pathsep.join([packages_path, src_path, script_dir])
