...
class IntegrationConfigService:
    ...
    async def test_connectivity(
        ...
        try:
            ...
            integration.status = IntegrationStatus.ERROR
            integration.health_status = f"error: {str(e)}"
            return {
                "success": False,
                "error": str(e),
                "integration_id": integration_id,
...
@pytest.fixture
def integration_service(encryption_service, health_checker, audit_service):
    """Create integration config service for testing."""
