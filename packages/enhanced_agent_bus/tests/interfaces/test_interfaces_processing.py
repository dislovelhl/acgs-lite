...
class TestValidationStrategyProtocol:
    """Tests for ValidationStrategy Protocol definition."""

    def test_protocol_is_not_none(self):
        assert ValidationStrategy is not None

    def test_protocol_is_runtime_checkable(self):
        vs = ConcreteValidationStrategy()
        assert isinstance(vs, ValidationStrategy)
...
class TestProcessingStrategyProtocol:
    """Tests for ProcessingStrategy Protocol definition."""

    def test_protocol_is_not_none(self):
        assert ProcessingStrategy is not None

    def test_protocol_is_runtime_checkable(self):
        ps = ConcreteProcessingStrategy()
        assert isinstance(ps, ProcessingStrategy)
...
class TestMessageHandlerProtocol:
    """Tests for MessageHandler Protocol definition."""

    def test_protocol_is_not_none(self):
        assert MessageHandler is not None

    def test_protocol_is_runtime_checkable(self):
        mh = ConcreteMessageHandler()
        assert isinstance(mh, MessageHandler)
...
class TestMessageProcessorProtocol:
    """Tests for MessageProcessorProtocol definition."""

    def test_protocol_is_not_none(self):
        assert MessageProcessorProtocol is not None

    def test_protocol_is_runtime_checkable(self):
        mp = ConcreteMessageProcessorProtocol()
        assert isinstance(mp, MessageProcessorProtocol)

    def test_has_process_method(self):
        assert hasattr(MessageProcessorProtocol, "process")


class TestRustProcessorProtocol:
    """Tests for RustProcessorProtocol definition."""

    def test_protocol_is_not_none(self):
        assert RustProcessorProtocol is not None

    def test_protocol_is_runtime_checkable(self):
        rp = ConcreteRustProcessor()
        assert isinstance(rp, RustProcessorProtocol)

    def test_has_validate_method(self):
        assert hasattr(RustProcessorProtocol, "validate")
