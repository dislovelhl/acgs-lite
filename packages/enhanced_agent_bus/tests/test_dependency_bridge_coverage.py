...
class TestModuleImports:
    ...
    def test_import_initialize(self):
        from packages.enhanced_agent_bus.dependency_bridge import initialize
...
class TestGetFeatureFlags:
    ...
    def test_does_not_reinitialize_if_already_initialized(self):
        ...
        with patch("packages.enhanced_agent_bus.dependency_bridge.initialize") as mock_init:
            get_feature_flags()
...
class TestOptionalImport:
    def test_returns_default_when_feature_unavailable(self):
        ...
        with patch(
            "packages.enhanced_agent_bus.dependency_bridge.is_feature_available",
            return_value=False,
        ):
    ...
    def test_calls_get_dependency_when_feature_available(self):
        ...
        with (
            ...
            patch(
                "packages.enhanced_agent_bus.dependency_bridge.get_dependency",
...
class TestGetMACIEnforcer:
    ...
    def test_returns_real_dependency_when_available(self):
        from packages.enhanced_agent_bus.dependency_bridge import get_maci_enforcer
...
class TestGetMACIRole:
    ...
    def test_returns_real_dependency_when_available(self):
        from packages.enhanced_agent_bus.dependency_bridge import get_maci_role
...
class TestGetMACIRoleRegistry:
    ...
    def test_returns_real_dependency_when_available(self):
        from packages.enhanced_agent_bus.dependency_bridge import get_maci_role_registry
