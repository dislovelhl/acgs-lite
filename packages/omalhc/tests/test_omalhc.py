"""End-to-end tests for omalhc — Constitutional Swarm Mesh."""
...
from omalhc.dna import AgentDNA, DNAValidationResult, constitutional_dna
from omalhc.swarm import NodeStatus, SwarmExecutor, TaskDAG, TaskNode
...
class TestDNASwarmIntegration:
    ...
    def test_multi_domain_swarm_with_dna(self) -> None:
        ...
        const = Constitution.from_rules(swarm_rules, name="omalhc-swarm")
