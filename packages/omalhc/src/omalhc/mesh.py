...
from omalhc.manifold import GovernanceManifold
...
class ConstitutionalMesh:
    ...
    def _maybe_settle_reputations(self, assignment_id: str) -> None:
        ...
        already_settled = assignment_id in self._settled_assignments
        ...
        # Apply manifold updates only once per settlement
        if not already_settled and self._manifold is not None:
