...
## Task 1: DAG Compiler (`src/omalhc/compiler.py`)
...
- Update `src/omalhc/__init__.py` to export `DAGCompiler, GoalSpec`

---

## Task 2: Benchmark Harness (`src/omalhc/bench.py`)
...
python -m pytest packages/omalhc/tests/test_bench.py -v --import-mode=importlib -m "not slow"
...
- `packages/omalhc/src/omalhc/swarm.py` — TaskDAG, TaskNode, SwarmExecutor
- `packages/omalhc/src/omalhc/dna.py` — AgentDNA, constitutional_dna
- `packages/omalhc/src/omalhc/capability.py` — CapabilityRegistry
- `packages/omalhc/src/omalhc/artifact.py` — ArtifactStore
- `packages/omalhc/src/omalhc/contract.py` — TaskContract
- `packages/omalhc/tests/test_omalhc.py` — existing test patterns
