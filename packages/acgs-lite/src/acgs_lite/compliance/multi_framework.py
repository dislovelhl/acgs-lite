...
Supports 18 frameworks across 12 jurisdictions and 8+ domain verticals.
...
# ---------------------------------------------------------------------------
# Registry of all 18 available compliance frameworks
# ---------------------------------------------------------------------------
...
_JURISDICTION_MAP: dict[str, list[str]] = {
    ...
    "asean": ["singapore_maigf", "iso_42001", "oecd_ai"],
...
# ---------------------------------------------------------------------------
# Domain -> additional frameworks (global, not scoped to jurisdiction)
# ---------------------------------------------------------------------------
