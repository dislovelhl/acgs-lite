...
def merge(
    ...
    *,
        ...
        if rule.id in conflict_ids:
            ...
            if strategy == "keep_self":
                ...
                if other_rank > self_rank:
                    ...
                    conflict_details.append({"rule_id": rule.id, "kept": "other", "strategy": strategy, "reason": reason})
                    ...
                    conflict_details.append({"rule_id": rule.id, "kept": "self", "strategy": strategy, "reason": reason})
    ...
    merged_constitution = _Constitution(
        ...
        rules=merged,
        metadata={**constitution.metadata, **other.metadata, "merge_strategy": strategy, "merge_sources": [constitution.name, other.name]},
    )
