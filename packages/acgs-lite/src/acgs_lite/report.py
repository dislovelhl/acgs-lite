...
def generate_markdown_report(report_data: dict[str, Any]) -> str:
    ...
    lines.append("|------------|-------------------|--------|")
    lines.append(
        "| Constitutional validation (optional Rust fast path) | Art. 9 Risk Management | ✅ Active |"
    )
    lines.append(
    ...
    lines.append("")
    lines.append(f"*Report generated by ACGS v{VERSION} — Constitutional Hash: {CONSTITUTIONAL_HASH}*")
    lines.append("")
