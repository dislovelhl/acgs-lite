...
def generate_markdown_report(report_data: dict[str, Any]) -> str:
    ...
    lines.append("")
    lines.append("**EU AI Act main high-risk obligations take effect on August 2, 2026.**")
    lines.append(
...
def generate_pdf_report(
    ...
    pdf.cell(
        0,
        6,
        text="EU AI Act main high-risk obligations take effect August 2, 2026.",
        new_x="LMARGIN",
        new_y="NEXT",
    )
    pdf.cell(
    ...
    pdf.multi_cell(
        ...
        text=(
            ...
            "Main high-risk obligations date: August 2, 2026.\n"
