...
class ComplianceReportExporter:
    ...
    def to_text(self) -> str:
        ...
        lines += [
            ...
            f"  Overall score: {_pct(r.overall_score)}  "
    ...
    def to_markdown(self) -> str:
        ...
        lines += [
            ...
            "",
            "*Generated by acgs-lite ComplianceReportExporter · "
            "Constitutional Hash: `608508a9bd224290`*",
        ]
        return "\n".join(lines)
    ...
    def to_json(self, indent: int = 2) -> str:
        ...
        data["title"] = self._title  # backward-compat alias
...
def _md_framework_section(fa: FrameworkAssessment) -> list[str]:
    lines: list[str] = [
        f"### {fa.framework_name} (`{fa.framework_id}`)",
        "",
